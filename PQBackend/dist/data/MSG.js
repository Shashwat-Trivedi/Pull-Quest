...
const MSG_PROFESSIONAL = (n, url, repo) => `
...
const MSG_TECHNICAL = (n, url, repo) => `
...
const MSG_COMMUNITY = (n, url, repo) => `
...
exports.MSG = MSG_PROFESSIONAL; // Change this to your preferred option
