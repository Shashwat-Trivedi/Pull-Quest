...
exports.ingestIssue = void 0;
const User_1 = __importDefault(require("../model/User"));
const rest_1 = require("@octokit/rest");
const MaintainerIssues_1 = __importDefault(require("../model/MaintainerIssues")); // Import the new model
const ingestIssue = async (req, res) => {
    try {
        const { userId, githubUsername, repository, issue: gh, stakingRequired, userAccessToken, 
        // Additional fields for bounty/staking
        difficulty, estimatedHours, bounty, xpReward, expirationDate, } = req.body;
        ...
        const existingIssue = await MaintainerIssues_1.default.findOne({ id: gh.id });
        if (existingIssue) {
            console.log(`Issue ${gh.id} already exists, updating...`);
            // Update existing issue with new data
            const updatedIssue = await MaintainerIssues_1.default.findOneAndUpdate({ id: gh.id }, {
        ...
        const newMaintainerIssue = new MaintainerIssues_1.default({
            // Core issue fields
            id: gh.id,
            number: gh.number,
...
exports.ingestIssue = ingestIssue;
//# sourceMappingURL=IssueIngestController.js.map