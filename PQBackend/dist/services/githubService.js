...
exports.GitHubOrganizationsService = exports.GitHubService = void 0;
...
class GitHubService {
    ...
    async getRepositoryLanguages(owner, repo) {
        try {
            const response = await axios_1.default.get(`${this.baseURL}/repos/${owner}/${repo}/languages`, {
                headers: this.getHeaders(),
            });
    ...
    async searchIssues(languages, organizations, options = {}) {
        try {
            ...
            const response = await axios_1.default.get(`${this.baseURL}/search/issues`, {
                headers: this.getHeaders(),
                params: {
                    q: query,
                    sort: "updated",
...
class GitHubOrganizationsService {
    constructor(token) {
        this.baseURL = "https://api.github.com";
        this.token = token;
    }
     ...
     */
    async getUserOrganizations(username, page = 1, perPage = 100) {
